...
import { assertAcademicAccess, evaluateActiveProofRunAccess, evaluateFacultyContextAccess, evaluateOfferingReadRoleAccess, evaluateProofRunSelectionAccess, evaluateStudentShellSessionMessageAccess, } from '../src/modules/academic-access.js';
function createAuth(roleCode, facultyId = 'faculty-1') {
    return {
        facultyId,
