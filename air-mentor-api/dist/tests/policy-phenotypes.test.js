...
import { buildCoEvidenceDiagnosticsFromRows, buildPolicyDiagnostics, classifyPolicyPhenotype, mergeCoEvidenceDiagnostics, mergePolicyDiagnostics, } from '../src/lib/msruas-proof-control-plane.js';
import { buildActionPolicyComparison, policyActionCatalogForStage, } from '../src/lib/proof-control-plane-playback-service.js';
...
function buildPrerequisiteSummary(overrides = {}) {
    return {
...
describe('policy phenotype classification', () => {
    ...
    it('keeps policy candidates aligned with the canonical action catalog for each stage', () => {
        const stageKeys = ['pre-tt1', 'post-tt1', 'post-tt2', 'post-assignments', 'post-see'];
