...
async function publishOperationalProjection(db, input) {
    ...
    if (proofOfferingIds.length > 0) {
        ...
        const schemeInsertRows = proofOfferingIds
...
async function invalidateProofBatchSessions(db, batchId) {
