...
export async function registerAcademicBootstrapRoutes(app, context, deps) {
    const { academicBootstrapQuerySchema, academicRoleCodes, buildAcademicBootstrap, buildPublicFacultyList, resolveAcademicStageCheckpoint, } = deps;
