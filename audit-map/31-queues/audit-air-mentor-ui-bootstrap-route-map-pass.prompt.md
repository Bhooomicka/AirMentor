AirMentor audit OS pass: route-map-pass
...
- Arctic slots are authenticated and model-visible but remain execution-guarded until `execution_verification_state=verified`
