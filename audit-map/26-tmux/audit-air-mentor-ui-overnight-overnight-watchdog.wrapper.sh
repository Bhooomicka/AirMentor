...
status_file=/home/raed/projects/air-mentor-ui/audit-map/29-status/audit-air-mentor-ui-overnight-overnight-watchdog.status
checkpoint_file=/home/raed/projects/air-mentor-ui/audit-map/30-checkpoints/audit-air-mentor-ui-overnight-overnight-watchdog.checkpoint
log_file=/home/raed/projects/air-mentor-ui/audit-map/22-logs/audit-air-mentor-ui-overnight-overnight-watchdog.log
command_file=/home/raed/projects/air-mentor-ui/audit-map/31-queues/audit-air-mentor-ui-overnight-overnight-watchdog.command.sh
...
{
  printf "[%s] session=%s\n" "$(timestamp_utc)" audit-air-mentor-ui-overnight-overnight-watchdog
