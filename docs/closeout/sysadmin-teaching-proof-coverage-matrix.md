...
| Hierarchy selectors | `SYSTEM_ADMIN` | faculties workspace top controls | academic-faculty, department, branch, batch, and section selector state | `LOCAL-FRONTEND` | `LIVE-ACCEPTANCE` | acceptance report | 01A, 03B |
...
| Students registry and student detail | `SYSTEM_ADMIN` | `#/admin/students` | students/enrollments/promotion + resolved policy | targeted student tests | `LIVE-ACCEPTANCE` | acceptance report | 03B |
| Faculty-members registry and faculty detail | `SYSTEM_ADMIN` | `#/admin/faculty-members` | faculty, appointments, grants, ownership, calendar | targeted faculty tests | `LIVE-TEACHING`, `LIVE-ACCEPTANCE` | teaching parity screenshot, acceptance report | 03B |
...
| Faculty calendar oversight | `SYSTEM_ADMIN` | faculty detail calendar workspace | faculty calendar admin workspace routes | targeted calendar tests | `LIVE-TEACHING` | teaching parity screenshot | 03B |
| Scoped registry launches | `SYSTEM_ADMIN` | faculties workspace launch cards | route state + selection state, including section-scoped launch context | `LOCAL-FRONTEND` | `LIVE-ACCEPTANCE` | acceptance report | 01A, 03B |
